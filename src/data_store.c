/*数据持久化层实现，纯文本文件存储，管道符分隔，增删改查全量读写模式 */
...
static void _seed_students(void)
{
    ...
    fprintf(fp, "2026000001|张三|男|2026|计算机科学与技术|13800138001|456789|\n");
    fprintf(fp, "2026000002|李四|女|2026|美术|13800138002|456789|\n");
    fprintf(fp, "2026000003|王五|男|2026|汉语言|13800138003|456789|\n");
    fprintf(fp, "2026000004|赵六|女|2026|英语|13800138004|456789|\n");
    fprintf(fp, "2026000005|孙七|男|2026|数学|13800138005|456789|\n");
...
static void _seed_teachers(void)
{
    ...
    if(fp==NULL) return;
    fprintf(fp, "100001|黄八|男|计算机科学与技术|13900139001|456789|\n");
    fprintf(fp, "100002|刘九|女|数学|13900139002|456789|\n");
    fclose(fp);
}
...
static void _seed_courses(void)
{
    ...
    fprintf(fp, "C001|C语言程序设计|0|4.0|100001|计算机科学与技术,数学|周一 第1-2节|60|0|0.4|0.6|C语言基础语法、指针、结构体、文件操作|1|1|16|2026-07-6|2026-07-20|\n");
    fprintf(fp, "C002|高等数学|0|5.0|100002|计算机科学与技术,数学|周三 第3-4节|80|0|0.3|0.7|函数极限、导数、积分、级数|1|1|16|2026-07-6|2026-07-20|\n");
    fprintf(fp, "C003|Python入门|1|2.0|100001|计算机科学与技术,数学|周五 第5-6节|40|0|0.5|0.5|Python基础、数据处理、可视化入门|1|1|8|2026-07-6|2026-07-20|\n");
